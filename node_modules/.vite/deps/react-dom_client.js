import { n as __commonJSMin, t as require_react } from "./react-EfA866_I.js";
...
var require_react_dom_client_development = /* @__PURE__ */ __commonJSMin(((exports) => {
	(function() {
		...
		function updateSuspenseComponent(current, workInProgress, renderLanes) {
			...
			(JSCompiler_object_inline_digest_2293 = didSuspend) || (JSCompiler_object_inline_digest_2293 = null !== current && null === current.memoizedState ? !1 : 0 !== (suspenseStackCursor.current & ForceSuspenseFallback));
			JSCompiler_object_inline_digest_2293 && (JSCompiler_object_inline_componentStack_2295 = !0, workInProgress.flags &= -129);
			JSCompiler_object_inline_digest_2293 = 0 !== (workInProgress.flags & 32);
			workInProgress.flags &= -33;
			if (null === current) {
				if (isHydrating) {
					JSCompiler_object_inline_componentStack_2295 ? pushPrimaryTreeSuspenseHandler(workInProgress) : reuseSuspenseHandlerOnStack(workInProgress);
					if (isHydrating) {
						...
						JSCompiler_temp && (warnNonHydratedInstance(workInProgress, JSCompiler_object_inline_message_2292), throwOnHydrationMismatch(workInProgress));
					}
					JSCompiler_object_inline_message_2292 = workInProgress.memoizedState;
					if (null !== JSCompiler_object_inline_message_2292 && (JSCompiler_object_inline_message_2292 = JSCompiler_object_inline_message_2292.dehydrated, null !== JSCompiler_object_inline_message_2292)) return JSCompiler_object_inline_message_2292.data === SUSPENSE_FALLBACK_START_DATA ? workInProgress.lanes = 16 : workInProgress.lanes = 536870912, null;
				...
				if (JSCompiler_object_inline_componentStack_2295) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_componentStack_2295 = workInProgress.mode, JSCompiler_object_inline_message_2292 = mountWorkInProgressOffscreenFiber({
					mode: "hidden",
					children: JSCompiler_object_inline_message_2292
				}, JSCompiler_object_inline_componentStack_2295), JSCompiler_object_inline_stack_2294 = createFiberFromFragment(JSCompiler_object_inline_stack_2294, JSCompiler_object_inline_componentStack_2295, renderLanes, null), JSCompiler_object_inline_message_2292.return = workInProgress, JSCompiler_object_inline_stack_2294.return = workInProgress, JSCompiler_object_inline_message_2292.sibling = JSCompiler_object_inline_stack_2294, workInProgress.child = JSCompiler_object_inline_message_2292, JSCompiler_object_inline_componentStack_2295 = workInProgress.child, JSCompiler_object_inline_componentStack_2295.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_componentStack_2295.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2293, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2294;
				pushPrimaryTreeSuspenseHandler(workInProgress);
				return mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_message_2292);
			}
			...
			if (null !== prevState && (JSCompiler_object_inline_message_2292 = prevState.dehydrated, null !== JSCompiler_object_inline_message_2292)) {
				if (didSuspend) workInProgress.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress), workInProgress.flags &= -257, workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes)) : null !== workInProgress.memoizedState ? (reuseSuspenseHandlerOnStack(workInProgress), workInProgress.child = current.child, workInProgress.flags |= 128, workInProgress = null) : (reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_componentStack_2295 = JSCompiler_object_inline_stack_2294.fallback, JSCompiler_object_inline_message_2292 = workInProgress.mode, JSCompiler_object_inline_stack_2294 = mountWorkInProgressOffscreenFiber({
					mode: "visible",
					children: JSCompiler_object_inline_stack_2294.children
				}, JSCompiler_object_inline_message_2292), JSCompiler_object_inline_componentStack_2295 = createFiberFromFragment(JSCompiler_object_inline_componentStack_2295, JSCompiler_object_inline_message_2292, renderLanes, null), JSCompiler_object_inline_componentStack_2295.flags |= 2, JSCompiler_object_inline_stack_2294.return = workInProgress, JSCompiler_object_inline_componentStack_2295.return = workInProgress, JSCompiler_object_inline_stack_2294.sibling = JSCompiler_object_inline_componentStack_2295, workInProgress.child = JSCompiler_object_inline_stack_2294, reconcileChildFibers(workInProgress, current.child, null, renderLanes), JSCompiler_object_inline_stack_2294 = workInProgress.child, JSCompiler_object_inline_stack_2294.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_stack_2294.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2293, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, workInProgress = JSCompiler_object_inline_componentStack_2295);
				else if (pushPrimaryTreeSuspenseHandler(workInProgress), isHydrating && console.error("We should not be hydrating here. This is a bug in React. Please file a bug."), JSCompiler_object_inline_message_2292.data === SUSPENSE_FALLBACK_START_DATA) {
					...
					JSCompiler_object_inline_message_2292 = JSCompiler_object_inline_message_2292 ? Error(JSCompiler_object_inline_message_2292) : Error("The server could not finish this Suspense boundary, likely due to an error during server rendering. Switched to client rendering.");
					...
					"string" === typeof JSCompiler_object_inline_digest_2293 && CapturedStacks.set(JSCompiler_object_inline_message_2292, JSCompiler_object_inline_digest_2293);
					queueHydrationError({
				...
				} else if (JSCompiler_object_inline_digest_2293 = 0 !== (renderLanes & current.childLanes), didReceiveUpdate || JSCompiler_object_inline_digest_2293) {
					...
					if (null !== JSCompiler_object_inline_digest_2293) {
						...
						if (0 !== (JSCompiler_object_inline_stack_2294 & 42)) JSCompiler_object_inline_stack_2294 = 1;
						else switch (JSCompiler_object_inline_stack_2294) {
							case 2:
							...
							case 268435456:
								...
								break;
							default: JSCompiler_object_inline_stack_2294 = 0;
						}
						JSCompiler_object_inline_stack_2294 = 0 !== (JSCompiler_object_inline_stack_2294 & (JSCompiler_object_inline_digest_2293.suspendedLanes | renderLanes)) ? 0 : JSCompiler_object_inline_stack_2294;
						if (0 !== JSCompiler_object_inline_stack_2294 && JSCompiler_object_inline_stack_2294 !== prevState.retryLane) throw prevState.retryLane = JSCompiler_object_inline_stack_2294, enqueueConcurrentRenderForLane(current, JSCompiler_object_inline_stack_2294), scheduleUpdateOnFiber(JSCompiler_object_inline_digest_2293, current, JSCompiler_object_inline_stack_2294), SelectiveHydrationException;
					}
					JSCompiler_object_inline_message_2292.data === SUSPENSE_PENDING_START_DATA || renderDidSuspendDelayIfPossible();
					workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
				} else JSCompiler_object_inline_message_2292.data === SUSPENSE_PENDING_START_DATA ? (workInProgress.flags |= 128, workInProgress.child = current.child, workInProgress = retryDehydratedSuspenseBoundary.bind(null, current), JSCompiler_object_inline_message_2292._reactRetry = workInProgress, workInProgress = null) : (current = prevState.treeContext, nextHydratableInstance = getNextHydratable(JSCompiler_object_inline_message_2292.nextSibling), hydrationParentFiber = workInProgress, isHydrating = !0, hydrationErrors = null, didSuspendOrErrorDEV = !1, hydrationDiffRootDEV = null, rootOrSingletonContext = !1, null !== current && (warnIfNotHydrating(), idStack[idStackIndex++] = treeContextId, idStack[idStackIndex++] = treeContextOverflow, idStack[idStackIndex++] = treeContextProvider, treeContextId = current.id, treeContextOverflow = current.overflow, treeContextProvider = workInProgress), workInProgress = mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_stack_2294.children), workInProgress.flags |= 4096);
				return workInProgress;
			}
			if (JSCompiler_object_inline_componentStack_2295) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_componentStack_2295 = JSCompiler_object_inline_stack_2294.fallback, JSCompiler_object_inline_message_2292 = workInProgress.mode, JSCompiler_temp = current.child, instance = JSCompiler_temp.sibling, JSCompiler_object_inline_stack_2294 = createWorkInProgress(JSCompiler_temp, {
				mode: "hidden",
				children: JSCompiler_object_inline_stack_2294.children
			}), JSCompiler_object_inline_stack_2294.subtreeFlags = JSCompiler_temp.subtreeFlags & 31457280, null !== instance ? JSCompiler_object_inline_componentStack_2295 = createWorkInProgress(instance, JSCompiler_object_inline_componentStack_2295) : (JSCompiler_object_inline_componentStack_2295 = createFiberFromFragment(JSCompiler_object_inline_componentStack_2295, JSCompiler_object_inline_message_2292, renderLanes, null), JSCompiler_object_inline_componentStack_2295.flags |= 2), JSCompiler_object_inline_componentStack_2295.return = workInProgress, JSCompiler_object_inline_stack_2294.return = workInProgress, JSCompiler_object_inline_stack_2294.sibling = JSCompiler_object_inline_componentStack_2295, workInProgress.child = JSCompiler_object_inline_stack_2294, JSCompiler_object_inline_stack_2294 = JSCompiler_object_inline_componentStack_2295, JSCompiler_object_inline_componentStack_2295 = workInProgress.child, JSCompiler_object_inline_message_2292 = current.child.memoizedState, null === JSCompiler_object_inline_message_2292 ? JSCompiler_object_inline_message_2292 = mountSuspenseOffscreenState(renderLanes) : (JSCompiler_temp = JSCompiler_object_inline_message_2292.cachePool, null !== JSCompiler_temp ? (instance = CacheContext._currentValue, JSCompiler_temp = JSCompiler_temp.parent !== instance ? {
				parent: instance,
				pool: instance
			} : JSCompiler_temp) : JSCompiler_temp = getSuspendedCache(), JSCompiler_object_inline_message_2292 = {
				baseLanes: JSCompiler_object_inline_message_2292.baseLanes | renderLanes,
				cachePool: JSCompiler_temp
			}), JSCompiler_object_inline_componentStack_2295.memoizedState = JSCompiler_object_inline_message_2292, JSCompiler_object_inline_componentStack_2295.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2293, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2294;
			pushPrimaryTreeSuspenseHandler(workInProgress);
			...
			null !== current && (JSCompiler_object_inline_digest_2293 = workInProgress.deletions, null === JSCompiler_object_inline_digest_2293 ? (workInProgress.deletions = [current], workInProgress.flags |= 16) : JSCompiler_object_inline_digest_2293.push(current));
			...
			if (!isFlushingWork && mightHavePendingSyncWork) {
				...
				do {
					...
					for (var root = firstScheduledRoot; null !== root;) {
						...
						0 !== (workInProgressRootRenderLanes$jscomp$0 & 3) && (didPerformSomeWork = !0, performSyncWorkOnRoot(root, workInProgressRootRenderLanes$jscomp$0));
						root = root.next;
					}
		...
		(function() {
			...
			if ("19.0.0-rc-b57d2823-20240822" !== isomorphicReactPackageVersion) throw Error("Incompatible React versions: The \"react\" and \"react-dom\" packages must have the exact same version. Instead got:\n  - react:      " + (isomorphicReactPackageVersion + "\n  - react-dom:  19.0.0-rc-b57d2823-20240822\nLearn more: https://react.dev/warnings/version-mismatch"));
		})();
